...
import qualified Epsilon.Generator.Arbitrary as Arbitrary
import qualified Epsilon.Generator.Common as Common
import qualified Epsilon.Generator.FromJSON as FromJSON
import qualified Epsilon.Generator.ToJSON as ToJSON
import qualified Epsilon.Generator.ToSchema as ToSchema
import qualified Epsilon.Hsc as Hsc
import qualified Epsilon.Options as Options
import qualified Epsilon.Type.Config as Config
import qualified Epsilon.Type.Flag as Flag
import qualified GHC.Hs as Ghc
import qualified GhcPlugins as Ghc
import qualified Paths_epsilon as This
import qualified System.Console.GetOpt as Console

-- | The compiler plugin. You can enable this plugin with the following pragma:
--
-- > {-# OPTIONS_GHC -fplugin=Epsilon #-}
--
-- This plugin accepts some options. Pass @-fplugin-opt=Epsilon:--help@ to see
-- what they are. For example:
--
-- > {-# OPTIONS_GHC -fplugin=Epsilon -fplugin-opt=Epsilon:--help #-}
--
...
parsedResultAction commandLineOptions _ hsParsedModule = do
  ...
  Monad.when (Config.help config)
    ...
    . fmap Ghc.text
    . lines
    $ Console.usageInfo ("Epsilon version " <> version) Flag.options
