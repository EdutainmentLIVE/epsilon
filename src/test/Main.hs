...
newtype T1 = T1C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon"
...
newtype T3 = T3C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --snake"
...
newtype T4 = T4C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --kebab"
...
newtype T5 = T5C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --title"
...
newtype T6 = T6C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --strip t6c1"
...
newtype T7 = T7C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --strip t7c1 --title"
...
newtype T8 = T8C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --title --strip T8c1"
...
newtype T11 = T11C1
  ...
  deriving (Eq, Show)
  deriving (Arbitrary, FromJSON, ToJSON, ToSchema) via "Epsilon --strip t11c1f1 --camel"
